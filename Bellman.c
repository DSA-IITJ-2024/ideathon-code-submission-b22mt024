...
// Function to initialize a new adjacency list node
...
// Function to find the index of a vertex based on its IATA code
...
// Function to implemment Bellman-Ford algorith
...
int main() {
  ...
  // Read airport and route data from CSV files
  ...
  // Find vertex indices for source and destination
